...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dyntapy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15604&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dyntapy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dyntapy` can be installed with:

```
conda install dyntapy
```

It is possible to list all of the versions of `dyntapy` available on your platform with:
